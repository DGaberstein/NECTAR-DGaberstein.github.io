...
const translations = {
  de: {
    ...
    "cultivation.cert1": "Zertifikat: GMP‑ready",
    "cultivation.cert2": "Zertifikat: ISO‑Cleanroom",
    "cultivation.cert3": "Zertifikat: AI‑Audit Trail",
    ...
    "cultivation.chart.title": "Luxus‑Qualitätsmetriken",
    ...
    "cultivation.gauge.note": "Verständlich visualisiert.",
    ...
    "pitch.hook.text": "Wussten Sie, dass 70 % der potenziellen Cannabis‑Konsument:innen Edibles meiden, weil Geschmack und Geruch stören?",
    "pitch.problem.title": "Problem",
    "pitch.problem.text": "Herkömmliche Cannabis‑Foods zerstören das kulinarische Erlebnis, Dosierung schwankt, Wiederkauf sinkt.",
    "pitch.solution.title": "Lösung",
    "pitch.solution.text": "NECTAR mikroverkapselt Cannabinoide. 100 % Wirkung, 0 % Beigeschmack. Wasserlöslich, geruchlos, hitzebeständig, konsistent.",
    "pitch.market.title": "Markt/Vorteil",
    "pitch.market.text": "Globaler Cannabismarkt wächst von USD 57,18 Mrd. (2023) auf USD 444,34 Mrd. bis 2030 (CAGR 34,03%).<br />UK‑Medizinalmarkt, Flower‑Volumen: 2,7 Mio. g (2022) auf 9,8 Mio. g (2024).",
    "pitch.cta.title": "Call to Action",
    "pitch.cta.text": "Wir suchen Pilotpartner und Pre‑Seed‑Kapital, um zu skalieren. Sprechen wir nächste Woche?",
    "pitch.sources.label": "Quellen:",
    "investor.eyebrow": "Shark‑Tank Snapshot",
    "investor.title": "Investor‑Snapshot",
    "investor.lead": "Die komprimierten Fakten, die Investor:innen in 90 Sekunden sehen wollen. Ersetzen Sie Platzhalter mit echten Zahlen.",
    "investor.stats1.value": "8 Pilot‑Gespräche*",
    "investor.stats1.label": "Pipeline DACH & NL",
    "investor.stats2.value": "60–70% Bruttomarge*",
    "investor.stats2.label": "B2B‑Ingredient + Lizenz",
    "investor.stats3.value": "6–12 Monate*",
    "investor.stats3.label": "Von Pilot zu Roll‑out",
    "investor.traction.title": "Traction",
    "investor.traction.item1": "3 PoCs in Vorbereitung (Restaurants & Beverage‑Labs)",
    "investor.traction.item2": "2 LOIs mit Pilot‑Volumen",
    "investor.traction.item3": "Erste Sensor‑QA‑Datenbank im Aufbau",
    "investor.model.title": "Geschäftsmodell",
    "investor.model.item1": "B2B‑Ingredient pro Portion + Setup‑Fee",
    "investor.model.item2": "Lizenz für Ghost‑Infusion‑Prozess",
    "investor.model.item3": "Langfristig: OEM‑Partnerschaften",
    "investor.gtm.title": "Go‑to‑Market",
    "investor.gtm.item1": "Fine‑Dining & Signature‑Bars als Leuchttürme",
    "investor.gtm.item2": "Pilot → Referenzmenü → Distributor",
    "investor.gtm.item3": "Co‑branding mit Premium‑Chefs",
    "investor.moat.title": "Moat / Vorteil",
    "investor.moat.item1": "Proprietäre Mikroverkapselung + QA‑Metriken",
    "investor.moat.item2": "Geschmacksneutralität als Differenzierung",
    "investor.moat.item3": "Regulatorische Vorarbeit",
    "investor.regulatory.title": "Regulatorik",
    "investor.regulatory.item1": "Fokus auf EU‑Compliance (NL)",
    "investor.regulatory.item2": "Dokumentation & Audit‑Trails",
    "investor.ask.title": "Investment‑Ask",
    "investor.ask.item1": "Pre‑Seed für 18 Monate Runway",
    "investor.ask.item2": "Use of Funds: R&D, Pilot‑Scaling, Zertifizierungen",
    "investor.ask.item3": "Ziel: Markteintritt & Serie‑A‑Readiness",
  ...
  en: {
    ...
    "cultivation.chart.title": "Luxury quality",
    "cultivation.chart.aroma": "Aroma",
    ...
    "pitch.hook.title": "Hook",
    "pitch.hook.text": "Did you know 70% of potential consumers avoid edibles because taste and odor get in the way?",
    "pitch.problem.title": "Problem",
    "pitch.problem.text": "Traditional cannabis foods ruin the culinary experience; dosing is inconsistent and repeat purchase suffers.",
    "pitch.solution.title": "Solution",
    "pitch.solution.text": "NECTAR micro‑encapsulates cannabinoids. 100% effect, 0% aftertaste. Water‑soluble, odorless, heat‑stable, consistent.",
    "pitch.market.title": "Market/edge",
    "pitch.market.text": "Global cannabis market: USD 57.18B (2023) → USD 444.34B by 2030 (CAGR 34.03%).<br />UK medical market: flower volume 2.7m g (2022) → 9.8m g (2024).",
    "pitch.cta.title": "Call to Action",
    "pitch.cta.text": "We’re looking for pilot partners and pre‑seed capital to scale. Can we talk next week?",
    "pitch.sources.label": "Sources:",
    "investor.eyebrow": "Shark Tank Snapshot",
    "investor.title": "Investor Snapshot",
    "investor.lead": "Compressed facts investors want in 90 seconds. Replace placeholders with real numbers.",
    "investor.stats1.value": "8 pilot conversations*",
    "investor.stats1.label": "DACH & NL pipeline",
    "investor.stats2.value": "60–70% gross margin*",
    "investor.stats2.label": "B2B ingredient + license",
    "investor.stats3.value": "6–12 months*",
    "investor.stats3.label": "From pilot to rollout",
    "investor.traction.title": "Traction",
    "investor.traction.item1": "3 PoCs in preparation (restaurants & beverage labs)",
    "investor.traction.item2": "2 LOIs with pilot volume",
    "investor.traction.item3": "First sensor QA database in progress",
    "investor.model.title": "Business model",
    "investor.model.item1": "B2B ingredient per serving + setup fee",
    "investor.model.item2": "Licensing for the Ghost‑Infusion process",
    "investor.model.item3": "Long‑term: OEM partnerships",
    "investor.gtm.title": "Go‑to‑market",
    "investor.gtm.item1": "Fine dining & signature bars as lighthouse accounts",
    "investor.gtm.item2": "Pilot → reference menu → distributor",
    "investor.gtm.item3": "Co‑branding with premium chefs",
    "investor.moat.title": "Moat / advantage",
    "investor.moat.item1": "Proprietary micro‑encapsulation + QA metrics",
    "investor.moat.item2": "Taste neutrality as differentiation",
    "investor.moat.item3": "Regulatory groundwork",
    "investor.regulatory.title": "Regulatory",
    "investor.regulatory.item1": "Focus on EU compliance (NL)",
    "investor.regulatory.item2": "Documentation & audit trails",
    "investor.ask.title": "Investment ask",
    "investor.ask.item1": "pre‑seed for 18 months runway",
    "investor.ask.item2": "Use of funds: R&D, pilot scaling, certifications",
    "investor.ask.item3": "Goal: market entry & Series‑A readiness",
  ...
  nl: {
    ...
    "pitch.hook.title": "Hook",
    "pitch.hook.text": "Wist je dat 70% van potentiële consumenten edibles vermijden omdat smaak en geur storen?",
    "pitch.problem.title": "Probleem",
    "pitch.problem.text": "Traditionele cannabis‑foods verstoren de culinaire ervaring; dosering is inconsistent en herhaalaankoop daalt.",
    "pitch.solution.title": "Oplossing",
    "pitch.solution.text": "NECTAR micro‑inkapselt cannabinoïden. 100% effect, 0% nasmaak. Wateroplosbaar, geurloos, hittebestendig, consistent.",
    "pitch.market.title": "Markt/voordeel",
    "pitch.market.text": "Wereldwijde cannabismarkt: USD 57,18 mrd. (2023) → USD 444,34 mrd. in 2030 (CAGR 34,03%).<br />UK‑medische markt: bloemvolume 2,7 mln g (2022) → 9,8 mln g (2024).",
    "pitch.cta.title": "Call to Action",
    "pitch.cta.text": "We zoeken pilotpartners en pre‑seed‑kapitaal om te schalen. Spreken we volgende week?",
    "pitch.sources.label": "Bronnen:",
    "investor.eyebrow": "Shark‑Tank Snapshot",
    "investor.title": "Investor‑snapshot",
    "investor.lead": "Gecomprimeerde feiten die investeerders in 90 seconden willen zien. Vervang placeholders met echte cijfers.",
    "investor.stats1.value": "8 pilotgesprekken*",
    "investor.stats1.label": "Pipeline DACH & NL",
    "investor.stats2.value": "60–70% brutomarge*",
    "investor.stats2.label": "B2B‑ingredient + licentie",
    "investor.stats3.value": "6–12 maanden*",
    "investor.stats3.label": "Van pilot naar rollout",
    "investor.traction.title": "Traction",
    "investor.traction.item1": "3 PoC’s in voorbereiding (restaurants & beverage‑labs)",
    "investor.traction.item2": "2 LOI’s met pilotvolume",
    "investor.traction.item3": "Eerste sensor‑QA‑database in opbouw",
    "investor.model.title": "Businessmodel",
    "investor.model.item1": "B2B‑ingredient per portie + setup‑fee",
    "investor.model.item2": "Licentie voor het Ghost‑Infusion‑proces",
    "investor.model.item3": "Op termijn: OEM‑partnerschappen",
    "investor.gtm.title": "Go‑to‑market",
    "investor.gtm.item1": "Fine dining & signature bars als lighthouse accounts",
    "investor.gtm.item2": "Pilot → referentiemenu → distributeur",
    "investor.gtm.item3": "Co‑branding met premium chefs",
    "investor.moat.title": "Moat / voordeel",
    "investor.moat.item1": "Eigen micro‑inkapseling + QA‑metrics",
    "investor.moat.item2": "Smaakneutraliteit als differentiatie",
    "investor.moat.item3": "Regulatoire voorwerk",
    "investor.regulatory.title": "Regelgeving",
    "investor.regulatory.item1": "Focus op EU‑compliance (NL)",
    "investor.regulatory.item2": "Documentatie & audit‑trails",
    "investor.ask.title": "Investment ask",
    "investor.ask.item1": "re‑seed voor 18 maanden runway",
    "investor.ask.item2": "Use of funds: R&D, pilots schalen, certificeringen",
    "investor.ask.item3": "Doel: marktintro & Series‑A readiness",
