...
const translations = {
  de: {
    ...
    "investor.stats1.label": "Pipeline DACH & NL (Beispiel)",
    "investor.stats2.value": "60–70% Bruttomarge*",
    "investor.stats2.label": "B2B‑Ingredient + Lizenz (Ziel)",
    "investor.stats3.value": "6–12 Monate*",
    "investor.stats3.label": "Von Pilot zu Roll‑out (Plan)",
    "investor.traction.title": "Traction (Beispiel)",
    ...
    "investor.ask.title": "Investment‑Ask (Beispiel)",
    "investor.ask.item1": "€[X] Pre‑Seed für 18 Monate Runway",
  ...
  en: {
    ...
    "investor.stats1.label": "DACH & NL pipeline (example)",
    "investor.stats2.value": "60–70% gross margin*",
    "investor.stats2.label": "B2B ingredient + license (target)",
    "investor.stats3.value": "6–12 months*",
    "investor.stats3.label": "From pilot to rollout (plan)",
    "investor.traction.title": "Traction (example)",
    ...
    "investor.ask.title": "Investment ask (example)",
    "investor.ask.item1": "€[X] pre‑seed for 18 months runway",
  ...
  nl: {
    ...
    "investor.stats1.label": "Pipeline DACH & NL (voorbeeld)",
    "investor.stats2.value": "60–70% brutomarge*",
    "investor.stats2.label": "B2B‑ingredient + licentie (doel)",
    "investor.stats3.value": "6–12 maanden*",
    "investor.stats3.label": "Van pilot naar rollout (plan)",
    "investor.traction.title": "Traction (voorbeeld)",
    ...
    "investor.ask.title": "Investment ask (voorbeeld)",
    "investor.ask.item1": "€[X] pre‑seed voor 18 maanden runway",
